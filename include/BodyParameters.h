...
public:
    ...
    const btVector3 bodyInitialPosition = btVector3(0, (0.6 + 0.0 * STATIC_PELVIS) * BODY_SCALE, 0);
    ...
    double L_LEG_MASS = 0.0433 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;
    ...
    double U_LEG_MASS = 0.1416 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;
    ...
    double FOOT_MASS = 0.0137 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;
    ...
    double L_ARM_MASS = 0.0252 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;
    ...
    double U_ARM_MASS = 0.325 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;
...
//    double PELVIS_MASS = 0.05 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;
    ...
    double SPINE_MASS = 0.201 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;
    ...
    double HEAD_MASS = 0.0826 * BODY_MASS * BODY_SCALE * !STATIC_PELVIS;

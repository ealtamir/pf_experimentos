...
void GenericJointDemo::keyboardCallback(unsigned char key, int x, int y)
{
	...
	case 'e':
		...
		break;
	case 'r':
		m_ragdolls[0]->m_bodies[5]->applyTorqueImpulse(btVector3(btScalar(50.),btScalar(50.),btScalar(50.)));
		break;
	case 'l':
		m_ragdolls[0]->m_bodies[3]->applyTorqueImpulse(btVector3(btScalar(50.),btScalar(50.),btScalar(50.)));
		break;
	default:

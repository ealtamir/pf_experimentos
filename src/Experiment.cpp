...
void Experiment::initPhysics()
{
    ...
    // This is related to the number of iterations performed by the collision solver algorithm.
...
btRigidBody* Experiment::createBall()
{
    float radius = 2.;
    int mass = 1;
    const btScalar r = btScalar(2);
    btVector3 origin(0, 0, 0);
    btCollisionShape* sphereShape = new btMultiSphereShape(&origin, &r, 1);

...
Se dividi\'o al cuerpo humano en: cabeza, tronco, miembro superior (brazo, antebrazo y mano), pelvis y miembro inferior (muslo, pierna y pie). \\
A los fines de este proyecto, s\'olo se consideraron pelvis y miembro inferior (ver Fig. \ref{fig:seg_and_art}(\protect\subref*{fig7:a})).\\
La Tabla \ref{table2} presenta la composici\'on de cada uno de los segmentos del humano virtual (de acuerdo a la biomec\'anica \cite{biomechanics}). \\
\begin {table}[H]
	\begin{center}
	\resizebox{\linewidth}{!}{%
		\begin{tabular}{ | c | c | c | c | c | c | c |}
	  		 \hline
	  		\multicolumn{2}{| c |}{\textbf{Parte}} & \textbf{Cantidad} & \textbf{Forma} & \textbf{Largo (en m)} & \textbf{Peso (en kg)} & \textbf{Uniones}\\
	  		\hline 
	  		\hline
			\multicolumn{2}{| c |}{Pelvis} & 1 & esf\'erico & 0.08655 & 9.9718 & Cadera\\
			\hline
			\hline
	  		\multirow{3}{*}{\begin{sideways}\parbox{1.5cm}{Miembro\\ inferior} \end{sideways} } & Muslo & 2 & esfero-cilindro & 0.4015 & 10.3368 & Cadera y Rodilla\\
	  																		\cline{2-7}
...
Para unir los distintos segmentos entre s\'i, se utilizaron articulaciones bisagra con 1 grado de libertad, en el eje X, para que los segmentos puedan moverse en dos ejes: el Z, donde ocurre la caminata, y el Y, perpendicular al piso (ver Fig. \ref{fig:seg_and_art}(\protect\subref*{fig7:b})). \\
...
Asimismo, la pelvis no puede rotar (se le impide hacerlo); y se restringe la amplitud con la que puede moverse la cadera (de $\frac{-\pi}{4}$ a $\frac{\pi}{4}$). Esto se realiza porque, en caso contrario, el b\'ipedo necesitar\'ia un sistema de control para mantener el equilibrio, y eso excede el alcance de este trabajo.
...
\begin{table}[H]%
  \centering
  	\begin{tabular}{ | c | c || c | c | c | c |}
			...
			\hline
			\multirow{4}{*}{\textbf{\begin{sideways}\ Actuador \end{sideways} }} & \textbf{Gen\'erico} &  2 & 2 & 1 & 1\\ 
	  															\cline{2-6}
...
La velocidad del individuo de tipo 2 oscila de forma irregular, pero no tiene picos demasiado elevados.\\ 
...
%\begin{adjustwidth}{1.1cm}{0cm}
Junto con las ideas esbozadas en la secci\'on anterior. 
...
Lo ocurrido con el individuo de tipo 1 (gen\'erico y sin funci\'on partida), que es el que tiene un \textit{fitness} m\'as alto, pero que no produce una caminata acorde, posiblemente se deba a que el tiempo de simulaci\'on empleado en el algoritmo gen\'etico, fuera corto.

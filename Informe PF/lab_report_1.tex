...
\end{figure} 
Para esta prueba se utiliz\'o el modelo matem\'atico que representa la posici\'on del cuerpo en el eje horizontal en funci\'on del tiempo $t$, representado por la siguiente ecuaci\'on: 
 \begin{equation}
...
\begin{table}[H]%
  \centering
  	\begin{tabular}{ | c | c || c | c | c | }
			...
			\hline 
			\hline
			\multirow{3}{*}{-0.5 $\boldsymbol{\frac{m}{s}}$} & 0.2 & 0.000249 $\frac{m}{s}$& 0.000498 & 0.997\\ \cline{2-5}
								& 0.5 & 0.000219 $\frac{m}{s}$ & 0.000438 & 0.999\\ \cline{2-5}
	  							& 0.8 & 0.001037 $\frac{m}{s}$ & 0.002074 & 0.997 \\ \cline{2-5}
	  		\hline 
			\hline
			\multirow{3}{*}{-3.5 $\boldsymbol{\frac{m}{s}}$} & 0.2 & 0.000057 $\frac{m}{s}$ & 0 & 1\\ \cline{2-5}
	  							& 0.5 & 0.000018 $\frac{m}{s}$ & 0 & 1 \\ \cline{2-5}
								& 0.8 & 0.3 $\frac{m}{s}$ & 0.0857 & 0.893 \\ \cline{2-5}
	  		\hline
			\hline
			\multirow{3}{*}{-4 $\boldsymbol{\frac{m}{s}}$} & 0.2 & 0.000473 $\frac{m}{s}$ & 0.00012 & 1\\ \cline{2-5}
	  							& 0.5 & 0.000424 $\frac{m}{s}$ & 0.00011 & 1 \\ \cline{2-5}
	  							& 0.8 & 1.23 $\frac{m}{s}$ & 0.3 & 0.625 \\ \cline{2-5}
	  		\hline
			\hline
			\multirow{3}{*}{-5 $\boldsymbol{\frac{m}{s}}$} & 0.2 & 1 $\frac{m}{s}$ & 0.2 & 0 \\ \cline{2-5}
	  							& 0.5 & 2.5 $\frac{m}{s}$ & 0.5 & 0 \\ \cline{2-5}
	  							& 0.8 & 4 $\frac{m}{s}$ & 0.8 & 0 \\ \cline{2-5}
			\hline
			\hline
			\multirow{3}{*}{-10 $\boldsymbol{\frac{m}{s}}$} & 0.2 & 2 $\frac{m}{s}$ & 0.2 & 0\\ \cline{2-5}
...
Dentro de los diversos modelos existentes (\cite{Wojtyra}\cite{flexibleMuscle}); en este proyecto se procur\'o utilizar uno que fuera sencillo pero representativo a la vez.\\ 
...
Se dividi\'o al cuerpo humano en: cabeza, tronco, miembro superior, pelvis y miembro inferior (muslo, pierna y pie). A los fines de este proyecto, s\'olo se consideraron la pelvis y el miembro inferior (ver Fig. \ref{fig:seg_and_art}).\\

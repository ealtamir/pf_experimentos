...
\textbf{No est\'a terminada a\'un} \\Siempre ha sido de inter\'es la simulaci\'on biomec\'anica de seres vivos, especialmente en las ciencias naturales (zoolog\'ia, medicina, etc.). Pero \'ultimamente se ha incrementado el inter\'es en otras \'areas de aplicaci\'on, como los videojuegos.
...
en particular, debe calcular el resultado de colisiones, arreglar los solapamiento
...
(por ejemplo, un v\'inculo para formar una articulaci\'on).\\
Para lograr todo esto, el simulador modela a partir de un conjunto de ecuaciones las distintas
restricciones que deben ser respetadas. Estos modelos reciben como dato la velocidad lineal
y angular de cada objeto, as\'i como también las fuerzas que act\'uan sobre los mismos. Dada esta
informaci\'on, el simulador debe resolver un sistema de ecuaciones cuya soluci\'on representa
...
complejidad lineal mencionados en la secci\'on anterior. \\
Este procedimiento, se lleva a cabo cada \textit{timestep} de la simulaci\'on; donde un \textit{timestep}
es el intervalo de tiempo que transcurre entre un cálculo de magnitudes y otro. Mientras 
menor sea el \textit{timestep} el simulador será más preciso pero tambi\'en consumir\'a m\'as tiempo
de c\'omputo.
...
Como ya se dijo, el humanoide fue modelado en \textit{Bullet} como un conjunto de segmentos, unidos por articulaciones -ver Fig. \ref{fig:seg_and_art}-. Los segmentos son cuerpos rig\'idos.
...
\begin{table}[H]%
  \centering
  	\begin{tabular}{ | c || c | c | c | c | }
			...
			\hline 
			\hline
			1 & Gen\'erico & S\'i & No & No\\ 
	  		\hline 
			2 & Gen\'erico & S\'i & S\'i & No\\ 
	  		\hline 
			3 & Gen\'erico & S\'i & S\'i & S\'i\\ 
	  		\hline 
			4 & Fourier & S\'i & S\'i & S\'i\\ 
	  		\hline 
			5 & Extra Fourier & S\'i & S\'i & S\'i\\ 
	  		\hline 
			6 & Doble coseno & S\'i & S\'i & S\'i\\ 
	  		\hline 
	\end{tabular}
  \captionsetup{justification=centering}

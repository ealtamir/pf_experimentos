...
El motor físico se encarga de la simulación de cuerpos rígidos y la interacción entre los mismos, en particular, debe calcular el resultado de colisiones, arreglar los solapamiento
de los cuerpos en el espacio de simulación, estimar las fuerzas producidas debido a la fricción y mantener el cumplimiento de restricciones que puedan existir entre los cuerpos 
(por ejemplo, un vínculo para formar una articulación).

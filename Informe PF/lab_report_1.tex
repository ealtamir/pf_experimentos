...
La primera, denominada ``funci\'on partida'' y que es opcional, el humanoide comienza con una posici\'on diferente a la que tendr\'a en el resto de la caminata (las dos extremidades bien extendidas), representa el primer paso dado por el individuo. Para simplificar el modelo, se decidi\'o que el tiempo considerado para el primer paso sea fijo, y de 0.7 segundos. Dicho valor fue extra\'ido de forma experimental. Se aplican actuadores gen\'ericos en cada uno de los cuatro segmentos movibles (muslos y piernas). \\
La segunda es el resto de la caminata, que debe ser c\'iclica y peri\'odica (para poder, eventualmente, repetirse \textit{ad infinitum}). Aqu\'i se pueden aplicar cualquiera de los actuadores vistos en la secci\'on anterior, que pueden ser distintos a los usados en la funci\'on partida, pero solo un tipo de ellos para los segmentos.
\\

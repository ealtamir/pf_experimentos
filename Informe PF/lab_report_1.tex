...
Los resultados exponen una limitaci\'on del motor f\'isico: no representa correctamente las colisiones el\'asticas entre esferas y cuerpos r\'igidos, que ocurren a velocidades bajas. Esto queda en evidencia en la Tabla \ref{table1}. En cada una de ellas el error fue de casi 1.\\
...
\begin{table}[H]%
  \centering
  	\begin{tabular}{ | c || c | c | c | c | }
			...
			\hline 
			\hline
			1 & Gen\'erico & No & S\'i & S\'i\\ 
	  		\hline 
			2 & Gen\'erico & S\'i & S\'i & No\\ 
	  		\hline 
			3 & Fourier & S\'i & S\'i & No\\ 
	  		\hline 
			4 & Extra Fourier & S\'i & S\'i & No\\ 
	  		\hline 
			5 & Doble coseno & S\'i & S\'i & No\\ 
	  		\hline 
	\end{tabular}
  \captionsetup{justification=centering}

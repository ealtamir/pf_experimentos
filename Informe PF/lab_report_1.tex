...
\begin{figure}[H]%
  ...
  \end{tikzpicture}
  \vspace{5pt}
  \caption{Esquema de un individuo (Ejemplo con actuador gen\'erico)}
...
\end{figure}
\noindent Como puede observarse en el caso de los individuos 4 y 5 (Fourier de orden 2 y 9, respectivamente), se producen picos pronunciados en la velocidad. Eso repercute en que la velocidad media no sea 1.3 $\frac{m}{s}$ (que es la velocidad objetivo), y ergo, en el m\'odulo de velocidad del \textit{fitness} (provocando que \'este sea m\'as bajo).\\
...
Por otra parte, el haber seguido la l\'inea de investigaci\'on de los cuadr\'upedos, si bien logr\'o una caminata, no fue suficiente. Un sistema de control para manejar el equilibrio ser\'ia necesario.\\

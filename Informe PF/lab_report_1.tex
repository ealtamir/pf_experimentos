...
\end{equation}
\\
Para efectuar la colisi\'on con el suelo, se emple\'o una esfera s\'olida, cuya masa y radio son $m_{sphere} = 1\ kg$ y $r_{sphere}=1\ m$,
respectivamente. En el ambiente utilizado no hay gravedad ($g = 0 \frac{m}{s}$), lo que posibilita utilizar la ecuaci\'on \eqref{eq:restitution_coef}.

...
\title{\textbf{\\ \underline{PROYECTO} \underline{FINAL} \\ \vspace*{2ex} \textcolor{cyan}{\textit{SIMULACI\'ON Y ANIMACI\'ON BIOMEC\'ANICA \\DE UN HUMANOIDE}  }  \vspace*{3ex}} } % Title
...
\begin{figure}[H] 
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \label{fig1:c} 
  \end{subfigure}%%
  \caption{Experimentos con $v_i = 10 \frac{m}{s}$}
  \label{fig1} 
  \vspace*{4ex}
\end{figure}
...
\begin{figure}[H] 
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \label{fig2:c} 
  \end{subfigure}%%
  \caption{Experimentos con $v_i = 3 \frac{m}{s}$}
  \label{fig2} 
  \vspace*{4ex}
\end{figure}
...
\begin{figure}[H] 
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \label{fig3:c} 
  \end{subfigure}%%
  \caption{Experimentos con $v_i = 1 \frac{m}{s}$}
  \label{fig3} 
\end{figure}
...
\begin {table}[H]
	\begin{center}
		\begin{tabular}{ | c || c | c | c | }
	  		...
	  		\hline
		\end{tabular}
		\caption{Experimentos con coeficiente de fricci\'on de 0.75 y $v_i = 1 \frac{m}{s}$ }
		\label{table:Exp1}
	\end{center}
\end{table}
...
\begin {table}[H]
	\begin{center}
		\begin{tabular}{ | c || c | c | c | }
	  		...
	  		\hline
		\end{tabular}
		\caption{Experimentos con coeficiente de fricci\'on de 0.75 y $v_i = -3.5 \frac{m}{s}$}
		\label{table:Exp2}
	\end{center}
\end{table}
...
\begin {table}[H]
	\begin{center}
		\begin{tabular}{ | c || c | c | c | }
	  		...
	  		\hline
		\end{tabular}
		\caption{Experimentos con coeficiente de fricci\'on de 0.75 y $v_i = -4 \frac{m}{s}$ }
		\label{table:Exp3}
	\end{center}
\end{table}
...
\begin {table}[H]
	\begin{center}
		\begin{tabular}{ | c || c | c | c | }
	  		...
	  		\hline
		\end{tabular}
		\caption{Experimentos con coeficiente de fricci\'on de 0.75 y $v_i = -5 \frac{m}{s}$ }
		\label{table:Exp4}
	\end{center}
\end{table}
...
\begin {table}[H]
	\begin{center}
		\begin{tabular}{ | c || c | c | c | }
	  		...
	  		\hline
		\end{tabular}
		\caption{Experimentos con coeficiente de fricci\'on de 0.75 y $v_i = -10 \frac{m}{s}$}
		\label{table:Exp5}
	\end{center}
\end{table}

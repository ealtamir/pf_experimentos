...
Entre los trabajos a futuro basados en este proyecto, se encuentran: lograr que la caminata sea m\'as natural y estable en el tiempo; que la caminata sea en 3D (y no plana); analizar el comportamiento de varios humanoides interactuando entre s\'i.

...
Para unir los distintos segmentos entre s\'i, se utilizaron articulaciones bisagra con 1 grado de libertad, en el eje X, para que los segmentos puedan moverse en dos ejes: el Z, donde ocurre la caminata, y el Y, perpendicular al piso (ver Fig. \ref{fig:seg_and_art}(\protect\subref*{fig7:a}) y (\protect\subref*{fig7:b})). \\
...
\begin{figure}[H]%
  ...
  \subfloat[][]{
  	\centering
	  \frame{\includegraphics[width=0.24\linewidth]{humanoid_axis.png}} 
	\label{fig7:a} 
  }
  \qquad
  \subfloat[][]{
  	\centering
	  \frame{\includegraphics[width=0.34\linewidth]{humanoid_articulations.png}}
	\label{fig7:b} 
  }
